...
var varArgWrapper = function() {
  ...
  if (typeof args[0] === "object") {
    args = args[0]; // User passed and array already
  }
  return [key, args, callback];
};
...
RedisClient.prototype.spop = RedisClient.prototype.SPOP = function (key, callback) {
  setFunctions.spop.call(this, MockInstance, key, callback);
}
RedisClient.prototype.srem = RedisClient.prototype.SREM = function (key, members, callback) {
  var args = varArgWrapper(arguments);
  setFunctions.srem.call(this, MockInstance, args[0], args[1], args[2]);
}
...
RedisClient.prototype.sadd = RedisClient.prototype.SADD = function (key, members, callback) {
  var args = varArgWrapper(arguments);
  setFunctions.sadd.call(this, MockInstance, args[0], args[1], args[2]);
}

/**
 * Sorted set functions
 */
 var sortedSetFunctions = require("./sorted-set.js");
 RedisClient.prototype.zadd = RedisClient.prototype.ZADD = function (key, score, elem, callback) {
  var args = varArgWrapper(arguments);
  sortedSetFunctions.zadd.call(this, MockInstance, args[0], args[1], args[2]);
}
RedisClient.prototype.zrange = RedisClient.prototype.ZRANGE = function (key, start, finish, callback) {
  var args = varArgWrapper(arguments);
  sortedSetFunctions.zrange.call(this, MockInstance, args[0], args[1], args[2]);
}
RedisClient.prototype.zremrangebyscore = RedisClient.prototype.ZREMRANGEBYSCORE = function (key, min, max, callback) {
  sortedSetFunctions.zremrangebyscore.call(this, MockInstance, key, min, max, callback);
}
