...
RedisClient.prototype.srem = RedisClient.prototype.SREM = function (key, elem, callback) {
  setFunctions.srem.call(this, MockInstance, key, elem, callback);
}
...
RedisClient.prototype.sadd = RedisClient.prototype.SADD = function (key, elem, callback) {
  setFunctions.sadd.call(this, MockInstance, key, elem, callback);
}
